...
declare namespace WebdriverIO {
  ...
  interface Hooks {
    ...
    beforeCommand?(commandName: string, args: any[]): Promise<any> | void
  ...
  interface Client<T> {
    checkElement: (selector: string) => Screenshot[]
    checkDocument: () => Screenshot[]
  }

  interface Options {
    visualRegression: VisualRegressionDetails
  }

  interface VisualRegressionDetails {
  ...
  interface VisualRegressionCompare {
    getScreenshotFile: (context: any) => string
    getReferencefile: (context: any) => string
    getDiffFile: (context: any) => string
  ...
  // EventEmitter
  interface Client<T> {
    addListener(event: string, listener: (...args: any[]) => void): Client<T>

    on(event: string, listener: (...args: any[]) => void): Client<T>

    once(event: string, listener: (...args: any[]) => void): Client<T>

    removeListener(event: string, listener: (...args: any[]) => void): Client<T>
  ...
  interface Client<T> {
    ...
    catch<P>(onRejected?: (error: any) => P | Client<P>): Client<P>
  ...
  interface Client<T> {
    ...
    addValue<P>(selector: string, value: string | number): Client<P>
    ...
    dragAndDrop<P>(sourceElem: string, destinationElem: string): Client<P>
    ...
    leftClick(xoffset?: number, yoffset?: number): Client<void> & undefined
    ...
    leftClick<P>(xoffset?: number, yoffset?: number): Client<P>
    ...
    middleClick<P>(xoffset?: number, yoffset?: number): Client<P>
    ...
    moveToObject<P>(xoffset?: number, yoffset?: number): Client<P>
    ...
    rightClick<P>(xoffset?: number, yoffset?: number): Client<P>
    ...
    selectByAttribute<P>(attribute: string, value: string | number): Client<P>
    ...
    selectByIndex<P>(selectElem: string, index: number): Client<P>
    ...
    selectByValue<P>(selectElem: string, value: string): Client<P>
    ...
    selectByVisibleText<P>(selectElem: string, text: string): Client<P>
    ...
    setValue<P>(values: number | string | string[]): Client<void> & undefined
  ...
  interface Client<T> {
    ...
    getCookie(): Client<Cookie & RawResult<string>[]> &
      Cookie[] &
      RawResult<string>[]
    getCookie(
      name: string,
    ): Client<Cookie & RawResult<string>> & Cookie & RawResult<string>
  ...
  interface Client<T> {
    ...
    getAttribute<P>(selector: string, attributeName: string): Client<P>
    ...
    getCssProperty<P>(selector: string, cssProperty: string): Client<P>
    ...
    getElementSize<P>(selector: string, dimension?: string): Client<P>
    ...
    getHTML<P>(selector: string, includeSelectorTag?: boolean): Client<P>
  ...
  interface Client<T> {
    ...
    /** @deprecated */
    applicationCacheStatus(): Client<RawResult<ApplicationCacheStatus>> &
      RawResult<ApplicationCacheStatus> &
      never
    ...
    cookie(): Client<RawResult<Cookie[] & RawResult<string>[]>> &
      RawResult<Cookie[] & RawResult<string>[]>

    cookie(
      method: Method,
      key?: (Cookie & RawResult<string>) | string,
    ): Client<RawResult<Cookie[] & RawResult<string>[]>> &
      RawResult<Cookie[] & RawResult<string>[]>
    ...
    elementIdAttribute<P>(id: ElementId, attributeName: string): Client<P>
    ...
    elementIdCssProperty<P>(id: ElementId, propertyName: string): Client<P>

    /** @deprecated */
    elementIdDisplayed(
      id: ElementId,
    ): Client<RawResult<boolean>> & RawResult<boolean> & never
    ...
    elementIdElement<P>(id: ElementId, selector: string): Client<P>
    ...
    elementIdElements<P>(id: ElementId, selector: string): Client<P>

    elementIdEnabled(
      id: ElementId,
    ): Client<RawResult<boolean>> & RawResult<boolean>
    ...
    elementIdRect(
      id: ElementId,
    ): Client<RawResult<DOMRect>> & RawResult<DOMRect>
    ...
    elementIdValue<P>(id: ElementId, values: string | string[]): Client<P>
    ...
    /** @deprecated */
    imeAvailableEngines(): Client<RawResult<string[]>> &
      RawResult<string[]> &
      never
    ...
    keys(
      value: string | string[],
    ): Client<RawResult<null>> & RawResult<null> & Client<void>

    /** @deprecated in favour of Actions.keyDown */
    keys<P>(value: string | string[]): Client<P>

    /** @deprecated */
    localStorage(): Client<RawResult<StorageItems[]>> &
      RawResult<StorageItems[]>
    ...
    /** @deprecated */
    localStorage<P>(method: Method, key?: string | StorageItems): Client<P>
    ...
    location(
      type: GeoLocation,
    ): Client<RawResult<number>> & RawResult<number> & never
    ...
    /** @deprecated */
    logTypes(): Client<RawResult<LoggingPreferences[]>> &
      RawResult<LoggingPreferences[]> &
      never
    ...
    /** @deprecated in favour of Actions.pointerMove */
    moveTo<P>(id: ElementId, xoffset: number, yoffset: number): Client<P>
    ...
    session<P>(action?: Method, sessionId?: string): Client<P> & null
    ...
    /** @deprecated */
    sessionStorage(): Client<RawResult<StorageItems>> &
      RawResult<StorageItems> &
      never
    ...
    /** @deprecated */
    sessionStorage<P>(method: Method, key: string): Client<P>
    ...
    /** @deprecated */
    sessionStorage<P>(method: Method, key: StorageItems): Client<P>
    ...
    /** @deprecated in favour of Actions.pointerDown */
    touchDown<P>(xoffset: number, yoffset: number): Client<P>
    ...
    /** @deprecated in favour of Actions.pointerMove */
    touchMove<P>(xoffset: number, yoffset: number): Client<P>
    ...
    /** @deprecated in favour of Actions.perform */
    touchScroll<P>(id: ElementId, xoffset: number, yoffset: number): Client<P>
    ...
    /** @deprecated in favour of Actions.pointerUp */
    touchUp<P>(xoffset: number, yoffset: number): Client<P>
    ...
    /** @deprecated in favour of /session/{session id}/window/rect */
    windowHandlePosition<P>(position: Position): Client<P>
    ...
    /** @deprecated in favour of /session/{session id}/window/rect */
    windowHandleSize<P>(windowHandle?: string, dimension?: Size): Client<P>

    /** @deprecated in favour of /session/{session id}/window/rect */
    windowHandleSize<P>(dimension?: Size): Client<P>
  ...
  interface Client<T> {
    ...
    chooseFile(selector: string, localPath: string): Client<void> & undefined

    chooseFile(localPath: string): Client<void>

    chooseFile<P>(selector: string, localPath: string): Client<P>
    ...
    scroll<P>(selector: string, xoffset: number, yoffset: number): Client<P>

    scroll<P>(xoffset: number, yoffset: number): Client<P>
    ...
    waitForEnabled<P>(selector: string, milliseconds?: number): Client<P>
    ...
    waitForEnabled<P>(milliseconds?: number, reverse?: boolean): Client<P>
    ...
    waitForExist<P>(selector: string, milliseconds?: number): Client<P>
    ...
    waitForExist<P>(milliseconds: number, reverse?: boolean): Client<P>
    ...
    waitForSelected<P>(selector: string, milliseconds?: number): Client<P>
    ...
    waitForSelected<P>(milliseconds?: number, reverse?: boolean): Client<P>
    ...
    waitForText<P>(selector: string, milliseconds?: number): Client<P>
    ...
    waitForText<P>(milliseconds?: number, reverse?: boolean): Client<P>
    ...
    waitForValue<P>(selector: string, milliseconds?: number): Client<P>
    ...
    waitForValue<P>(milliseconds?: number, reverse?: boolean): Client<P>
    ...
    waitForVisible<P>(selector: string, milliseconds?: number): Client<P>
    ...
    waitForVisible<P>(milliseconds?: number, reverse?: boolean): Client<P>
  ...
  interface Client<T> {
    ...
    setViewportSize(size: Size, type?: boolean): Client<void> & undefined

    setViewportSize<P>(size: Size, type?: boolean): Client<P>
